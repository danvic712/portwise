...
namespace Portwise.Infrastructure.Migrations
{
    ...
    [Migration("20260916140732_AddStockDataSyncSettingsAndPerStockJobs")]
    partial class AddStockDataSyncSettingsAndPerStockJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portwise.Domain.Models.StockDataSyncJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_stock_data_sync_jobs");

                    b.HasIndex("DeduplicationKey")
                        .IsUnique()
                        .HasDatabaseName("uq_stock_data_sync_jobs_deduplication_key");
                    ...
                    b.HasIndex("StatusCode", "AvailableAtUtc", "CreatedAtUtc")
                        .HasDatabaseName("ix_stock_data_sync_jobs_claim");

                    b.ToTable("stock_data_sync_jobs", "public", t =>
                        {
                            t.HasCheckConstraint("ck_stock_data_sync_jobs_attempt_count", "attempt_count >= 0");

                            t.HasCheckConstraint("ck_stock_data_sync_jobs_status_code", "status_code IN ('pending', 'running', 'completed', 'completed_with_failures', 'failed')");
                        });
                });

            modelBuilder.Entity("Portwise.Domain.Models.StockDataSyncSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_stock_data_sync_settings");

                    b.ToTable("stock_data_sync_settings", "public", t =>
                        {
                            t.HasCheckConstraint("ck_stock_data_sync_settings_revision", "revision > 0");
                        });

                    b.HasData(
                        new
                        {
                            Id = new Guid("01a0929e-0a28-7d0f-9b6e-58b9c13d7e20"),
                            CreatedAtUtc = new DateTimeOffset(new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Enabled = true,
                            Revision = 1L,
                            RunTimesJson = "[\"18:00\"]",
                            TimeZoneId = "Asia/Shanghai",
                            UpdatedAtUtc = new DateTimeOffset(new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
