...
namespace DividendHarvest.Infrastructure.Tests;
...
public sealed class DatabaseLifecycleTests
{
    ...
    private static DividendHarvestDbContext CreateDbContext(string databasePath)
    {
    ...
    private static async Task<IReadOnlyCollection<string>> ReadTableNamesAsync(
        DividendHarvestDbContext dbContext)
    {
